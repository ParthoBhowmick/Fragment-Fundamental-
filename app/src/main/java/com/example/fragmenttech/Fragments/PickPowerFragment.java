 ...
 * {@link PickPowerFragment.OnPickFragmentInteractionListener} interface
...
public class PickPowerFragment extends Fragment {
    ...
    private OnPickFragmentInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnPickFragmentInteractionListener) {
            mListener = (OnPickFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnPickFragmentInteractionListener {
